...
public class PictureAdapterRecyclerView extends RecyclerView.Adapter<PictureAdapterRecyclerView.PictureViewHolder> {
    ...
    public PictureViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //Aqui se trata la lista o recycler  y todas sus caracteristicas
    ...
    public void onBindViewHolder(PictureViewHolder holder, int position) {
        //Método que tiene acceso a nuestras views, además aquí se establece el orden de como se acomoda cada cardview
        ...
        //Sobreescribiendo el metodo setOnClik
